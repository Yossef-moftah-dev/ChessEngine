...
#ifdef __GNUC__
#define PACK(__Decleration__) __Declecration__ __attribute__((__packed__))
#endif

template<class T>
static std::string TrimNumber(const T number, double divisor, const std::string& suffix)
{
